...
#     # Owner notification email / Resend settings.
#     owner_email: str = ""
#     resend_api_key: str = ""

#     # Existing SMTP settings kept for local compatibility.
#     smtp_host: str = ""
#     smtp_port: int = 587
#     smtp_user: str = ""
#     smtp_password: str = ""
...
class Settings(BaseSettings):
    ...
    # Existing SMTP settings kept for compatibility.
    smtp_host: str = ""
    smtp_port: int = 587
    smtp_user: str = ""
    smtp_password: str = ""
    ...
    cors_origins: str = (
        ...
        "http://localhost:5174,"
        "http://127.0.0.1:5174,"
        "https://r-r-international-bay.vercel.app"
    )
